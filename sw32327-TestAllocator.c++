...
template <typename A>
struct allocate_test : testing::Test {
    // --------
    // typedefs
    // --------
...
// if there isn't room for another free block, allocate allocates the entire block
...
// if there isn't enough room to allocate a new block, trigger bad_alloc expection
...
template <typename A>
struct deallocate_test : testing::Test {
    // --------
    // typedefs
    // --------
...
typedef testing::Types<
            my_allocator<char,   10000>,
            my_allocator<int,    10000>,
            my_allocator<double, 10000>>
        deallocate_types;
